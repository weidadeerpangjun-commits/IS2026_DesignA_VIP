(function () {
  ...
  const messages = {
    zh: {
      ...
      "schdb.topicHint": "每行一项；中英文行数宜一致，按行对应。",
      "schdb.fieldIntro": "简介",
      "schdb.fieldLoc": "地点（选填）",
      "schdb.fieldDetail": "详情（选填，展示页可展开显示）",
      "schdb.fieldGroupMatrix": "分组表（Excel 粘贴）",
      "schdb.groupPasteHint":
        "从 Excel 复制后粘贴到下方：第一行为表头，列之间为 Tab。中文表与英文表列数与行数宜一致；可只填一侧。下方实时预览；相邻相同单元格会自动合并显示。",
      "schdb.subZh": "中文",
      "schdb.subEn": "English",
      "schdb.edit": "编辑",
      "schdb.delete": "删除",
      "schdb.doneEdit": "完成编辑",
      "schdb.cancelEdit": "取消",
      "schdb.dragHandleTitle": "拖拽调整场次顺序",
      "schdb.dragHandleAria": "拖拽调整本日场次顺序",
    ...
    en: {
      ...
      "schdb.topicHint": "One session/topic per line; Zh and En rows should align.",
      ...
      "schdb.groupPasteHint":
        "Copy from Excel and paste below: first row is headers; use tabs between columns. Zh and En grids should align when both are used. Preview updates as you type; adjacent identical cells merge in the preview and on the schedule page.",
      "schdb.subZh": "Chinese",
      "schdb.subEn": "English",
      "schdb.edit": "Edit",
      "schdb.delete": "Delete",
      ...
      "schdb.dragHandleTitle": "Drag to reorder sessions within this day",
      "schdb.dragHandleAria": "Drag to reorder sessions within this day",
      ...
      "hotel.rafflesAlt": "Andaz hotel logo",
      "hotel.hotelName": "Andaz Shenzhen Bay",
      "hotel.subAddress": "Location",
      "hotel.addressFull":
        "2600 Keyuan South Road, Nanshan District, Shenzhen 518054, Guangdong, China",
      "hotel.viewRoute": "Navigate",
      ...
      "hotel.breakfastTime": "6:30AM-10:30AM",
      "hotel.breakfastVenue": "Club House, 6F",
      "hotel.subNotice": "Hotel Check-in Instructions",
      "hotel.notice1": "Check-in: After 15:00PM",
      "hotel.notice2": "Check-out: Before 12:00PM",
      "hotel.notice2detail":
        "If you are leaving on August 7th, please take all the luggage and check out your room before heading to BISZ campus in the morning. All luggage will be stored in a designated area on campus.",
      "hotel.notice3":
        "If you need help during the stay, please contact the Administration and Human Resources Department of your campus or ASCEND.",
      ...
      "transport.timetableLead":
        "To facilitate commuting during the training period, we has arranged shuttle buses between school and hotel. Please plan your time accordingly and arrive at the pick-up point at least 10 minutes in advance. The buses will depart on time.",
